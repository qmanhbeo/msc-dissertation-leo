...
## PDFs Present (matching a citation key in `references.bib`)
...
All 41 cited works now have PDFs on disk. The remaining entries below are policy documents, datasets, or software — not traditional papers with PDFs.

### Policy documents / datasets (available as webpages, not paper PDFs)

| Key | URL |
|---|---|
| **UN2015** | `https://sdgs.un.org/2030agenda` |
| **Paris2015** | `https://unfccc.int/process-and-meetings/the-paris-agreement` |
| **IPCC2022** | `https://www.ipcc.ch/report/ar6/wg2/` |
| **OECD2019** | `https://oecd.ai/en/ai-principles` |
| **EUAI2024** | `https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689` |
| **UNESCO2021** | `https://unesdoc.unesco.org/ark:/48223/pf0000381137` |
| **UKAI2021** | `https://www.gov.uk/government/publications/national-ai-strategy` |
| **UNAI2024** | `https://www.un.org/sites/un2.un.org/files/governing_ai_for_humanity_final_report_en.pdf` |
| **AUAI2024** | `https://au.int/en/documents/20240603/continental-artificial-intelligence-strategy` |
| **Sachs2024** | `https://dashboards.sdgindex.org/` |
| **Sachs2025** | `https://dashboards.sdgindex.org/` |

### Datasets / software (no PDF to download)

| Key | Location |
|---|---|
| **Aurora2020SDGSurvey** | Zenodo: `10.5281/zenodo.3798385` |
| **SDGBenchmark** | GitHub: `https://github.com/SDGClassification/benchmark` |
| **SDGi2024** | HuggingFace: `https://huggingface.co/datasets/UNDP/sdgi-corpus` |
| **UNGDC2024** | Harvard Dataverse: `10.7910/DVN/0TJX8Y` |
