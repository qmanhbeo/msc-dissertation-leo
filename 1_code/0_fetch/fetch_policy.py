...
Output: 2_data/0_raw/policy_scrape/pdfs/<name>.pdf
        2_data/0_raw/policy_scrape/texts/<name>.txt
        2_data/0_raw/policy_scrape/artifact/metadata.json

Run from project root:
    python 1_code/0_fetch/fetch_policy.py
"""
...
def main(local_files_only: bool = False) -> None:
    ...
    metadata = {
        ...
        "generated_by": "1_code/0_fetch/fetch_policy.py",
