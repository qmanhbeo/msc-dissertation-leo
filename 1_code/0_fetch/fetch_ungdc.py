...
Output: 2_data/0_raw/ungdc/
        2_data/0_raw/ungdc/TXT/              — extracted corpus (11,141 speeches by session)
        2_data/0_raw/ungdc/Speakers_by_session.xlsx
        2_data/0_raw/ungdc/README.txt
        2_data/0_raw/ungdc/UNGDC_1946-2025.tar.gz
        2_data/0_raw/ungdc/metadata.json

Run from project root:
    python 1_code/0_fetch/fetch_ungdc.py
