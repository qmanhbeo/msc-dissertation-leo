...
Output: 2_data/1a_preprocessed_multilabel/osdg/osdg_clean.jsonl  — filtered, cleaned records
        2_data/1a_preprocessed_multilabel/osdg/osdg_clean.csv    — flat CSV for inspection
...
Run from project root:
    python 1_code/1a_preprocess_multilabel/preprocess_osdg.py
"""
...
OUTPUT_JSONL = Path("2_data/1a_preprocessed_multilabel/osdg/osdg_clean.jsonl")
OUTPUT_CSV = Path("2_data/1a_preprocessed_multilabel/osdg/osdg_clean.csv")
