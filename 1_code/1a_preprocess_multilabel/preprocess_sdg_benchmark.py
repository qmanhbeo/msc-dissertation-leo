...
Output: 2_data/1a_preprocessed_multilabel/sdg_benchmark/benchmark_clean.jsonl  — positive examples only
        2_data/1a_preprocessed_multilabel/sdg_benchmark/benchmark_clean.csv    — flat CSV for inspection
...
Run from project root:
    python 1_code/1a_preprocess_multilabel/preprocess_sdg_benchmark.py
"""
...
OUTPUT_JSONL = Path("2_data/1a_preprocessed_multilabel/sdg_benchmark/benchmark_clean.jsonl")
OUTPUT_CSV = Path("2_data/1a_preprocessed_multilabel/sdg_benchmark/benchmark_clean.csv")
