"""
Preprocess SDG Knowledge Hub corpus for multi-label SDG classification.

Input:  2_data/0_raw/sdg_knowledge_hub/sdg_knowledge_hub.csv  (9,172 rows, multi-label)
Output: 2_data/1a_preprocessed_multilabel/sdg_knowledge_hub/sdg_knowledge_hub_clean.jsonl
        2_data/1a_preprocessed_multilabel/sdg_knowledge_hub/sdg_knowledge_hub_clean.csv
...
Role in pipeline:
  Supervised multi-label counterpart — provides journalistic-domain SDG reference
  with full multi-label signal preserved. Output uses "sdgs" (list of ints) field.

Run from project root:
    python 1_code/1a_preprocess_multilabel/preprocess_sdg_knowledge_hub.py
"""
...
OUTPUT_JSONL = Path("2_data/1a_preprocessed_multilabel/sdg_knowledge_hub/sdg_knowledge_hub_clean.jsonl")
OUTPUT_CSV = Path("2_data/1a_preprocessed_multilabel/sdg_knowledge_hub/sdg_knowledge_hub_clean.csv")
