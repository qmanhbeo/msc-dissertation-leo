...
def main() -> None:
    ...
    if args.bootstrap and args.bootstrap > 0:
        ...
        # ---- Bootstrap CI table for Appendix A.1 (canonical column only) ----
        a1_tables_dir = Path(args.output_dir) / "appendix" / "a1_sdg_source_comparison" / "tables"
        a1_tables_dir.mkdir(parents=True, exist_ok=True)
        ci_lines = [
        ...
        (a1_tables_dir / "tab_validation_ci.tex").write_text("\n".join(ci_lines) + "\n", encoding="utf-8")
        log.info("Saved: %s", a1_tables_dir / "tab_validation_ci.tex")
