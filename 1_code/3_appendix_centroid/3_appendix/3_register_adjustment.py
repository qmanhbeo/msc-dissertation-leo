    ...
    *,
    ...
    return {
        ...
        "classifier_vector_source": str(
            DEFAULT_OUTPUT_ROOT / ROBUSTNESS_OUTPUT_SUBDIR / "sdg_balanced_register_vector.npy"
        ),
        "regression_vector_source": str(
            DEFAULT_OUTPUT_ROOT / ROBUSTNESS_OUTPUT_SUBDIR / "regression_register_vector.npy"
        ),
