...
def main() -> None:
    ...
    log.debug("  Research hard-assignment profile (proportion per SDG):")
    for i, v in enumerate(res_hard):
        log.debug("    SDG %2d: %.4f", i + 1, v)
    ...
    log.debug("  Document-weighted hard-assignment profile (proportion per SDG):")
