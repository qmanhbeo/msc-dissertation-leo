...
def write_table(path: Path, summary_rows: list[dict]) -> None:
    lines = [
        ...
        r"\toprule",
        r"Policy source family & Docs & Segments & \shortstack[l]{Top 3 SDGs\\(doc-weighted)} & \shortstack[l]{Mean semantic\\gap vs research} & \shortstack[c]{Largest\\gap SDG} & Interpretation note \\",
        r"\midrule",
    ]
