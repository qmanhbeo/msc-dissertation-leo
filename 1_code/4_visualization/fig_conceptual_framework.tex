...
\tikzset{
  ...
  label/.style={font=\footnotesize\itshape, align=center, text=gray!60},
}
...
\draw[arrow, draw=research!50] ([yshift=0.2cm]l1.north) -| ([xshift=-0.5cm]top.west)
  -- (top.west);
...
\node[base, fill=white, draw=gray!40, text width=10cm,
      ...
      below=0.5cm of $(cov.south)!0.5!(sem.south)$]
