...
MANUSCRIPT_FIGURE_FILES = [
    ...
    "fig9_h1_grid.pdf",
    "fig9_h1_grid.png",
    "fig10_concept_coverage.pdf",
    "fig10_concept_coverage.png",
    "fig12_register_convergence.pdf",
    "fig12_register_convergence.png",
]
...
MANUSCRIPT_APPENDIX_FIGURE_FILES = [
    ...
    "appendix/c_sample_stability/figures/fig11_sample_stability.pdf",
    "appendix/c_sample_stability/figures/fig11_sample_stability.png",
    "appendix/h1_cross_method_gap_values/figures/fig13_cross_method_heatmap.pdf",
    "appendix/h1_cross_method_gap_values/figures/fig13_cross_method_heatmap.png",
]
