...
Run from project root:
    python 1_code/7_main_analysis/1_canonical/0_pca_semantic_landscape.py
"""
...
def write_num_tex(path: Path, payload: dict) -> None:
    ...
    lines = [
        "% Auto-generated by 1_code/7_main_analysis/1_canonical/0_pca_semantic_landscape.py — do not edit manually",
