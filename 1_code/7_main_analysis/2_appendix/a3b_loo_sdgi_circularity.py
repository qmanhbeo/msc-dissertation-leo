...
Run from project root:
    python 1_code/7_main_analysis/2_appendix/a3b_loo_sdgi_circularity.py
"""
...
def run(args: argparse.Namespace) -> None:
    ...
    result = {
        "script": "1_code/7_main_analysis/2_appendix/a3b_loo_sdgi_circularity.py",
    ...
    num_lines = [
        "% Auto-generated by 1_code/7_main_analysis/2_appendix/a3b_loo_sdgi_circularity.py — do not edit manually",
