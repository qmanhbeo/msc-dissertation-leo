...
Run from project root:
    python 1_code/7_main_analysis/3_appendix/5_sdg4_lexical_audit.py
"""
...
def write_table(path: Path, rows: list[dict]) -> None:
    lines = [
        "% Auto-generated by 1_code/7_main_analysis/3_appendix/5_sdg4_lexical_audit.py — do not edit manually",
...
def main() -> None:
    ...
    rows: list[dict] = []
    summary = {
        "generated_from": "1_code/7_main_analysis/3_appendix/5_sdg4_lexical_audit.py",
