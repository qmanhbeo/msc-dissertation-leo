...
Run from project root:
    python 1_code/7_main_analysis/3_appendix/7_semantic_gap_text_interpretability.py
"""
...
def write_table(path: Path, rows: list[dict[str, Any]]) -> None:
    lines = [
        "% Auto-generated by 1_code/7_main_analysis/3_appendix/7_semantic_gap_text_interpretability.py -- do not edit manually",
...
def main() -> None:
    ...
    summary = {
        "generated_from": "1_code/7_main_analysis/3_appendix/7_semantic_gap_text_interpretability.py",
