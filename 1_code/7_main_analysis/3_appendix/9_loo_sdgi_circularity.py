...
Outputs:
   4_outputs/appendix/a3_sdgi_circularity/data/loo_sdgi_circularity.json
   4_outputs/appendix/a3_sdgi_circularity/data/loo_sdgi_circularity.csv
   4_outputs/appendix/a3_sdgi_circularity/tables/num_loo_sdgi_circularity.tex

Run from project root:
    python 1_code/7_main_analysis/3_appendix/9_loo_sdgi_circularity.py
"""
...
def main() -> None:
    ...
    result = {
        "script": "1_code/7_main_analysis/3_appendix/9_loo_sdgi_circularity.py",
    ...
    num_lines = [
        "% Auto-generated by 1_code/7_main_analysis/3_appendix/9_loo_sdgi_circularity.py — do not edit manually",
