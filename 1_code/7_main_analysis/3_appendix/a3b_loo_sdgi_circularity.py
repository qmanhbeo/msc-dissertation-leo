...
Convention notes:
  ...
  - SDGi segment isolation reuses the source-family map from
     a2_policy_source_family_sensitivity.py (source_doc -> sdgi_vnr_vlr).

Outputs:
   4_outputs/appendix/a3b_sdgi_circularity/data/loo_sdgi_circularity.json
   4_outputs/appendix/a3b_sdgi_circularity/data/loo_sdgi_circularity.csv
   4_outputs/appendix/a3b_sdgi_circularity/tables/num_loo_sdgi_circularity.tex

Run from project root:
    python 1_code/7_main_analysis/3_appendix/a3b_loo_sdgi_circularity.py
"""
...
def main() -> None:
    ...
    result = {
        "script": "1_code/7_main_analysis/3_appendix/a3b_loo_sdgi_circularity.py",
