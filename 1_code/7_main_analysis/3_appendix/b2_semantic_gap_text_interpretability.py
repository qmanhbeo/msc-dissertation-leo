...
Run from project root:
    python 1_code/7_main_analysis/3_appendix/b2_semantic_gap_text_interpretability.py
"""
...
def main() -> None:
    ...
    summary = {
        "generated_from": "1_code/7_main_analysis/3_appendix/b2_semantic_gap_text_interpretability.py",
