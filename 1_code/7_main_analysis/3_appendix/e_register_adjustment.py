...
Outputs:
  4_outputs/appendix/e_register_adjustment/tables/tab_register_adjusted_semgap.tex
  4_outputs/appendix/e_register_adjustment/tables/num_register_adjustment.tex

Run from project root:
    python 1_code/7_main_analysis/3_appendix/e_register_adjustment.py
"""
...
def main() -> None:
    ...
    num_lines = [
        "% Auto-generated by 1_code/7_main_analysis/3_appendix/e_register_adjustment.py",
