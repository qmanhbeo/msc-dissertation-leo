...
\node[t3, below=of p_prep] (p_seg) {\textbf{Segment + Merge}\\4 sources $\rightarrow$ segment\_text\\dedup $\rightarrow$ 40,547};
\node[t1, below=of ref_prep] (ref_seg) {\textbf{Segment + Bypass}\\3 seg (KH, SDGi, Aurora);\\2 bypass (OSDG, Benchmark)\\(62,513 total)};

%% ====================  ROW 4: EMBED  ====================

\node[shared, below=1.2cm of p_seg] (embed)
  {\textbf{Embedding}\\all-mpnet-base-v2 (768d, L2-normalised)\\
   \textnormal{Research 3,105,144 $\mid$ Policy 40,547 $\mid$ Reference 62,513 $\mid$ Total 3,208,204}};
...
\node[t3, right=0.3cm of score_res] (score_pol)
  {\textbf{Score Policy}\\LR argmax over 17 SDGs\\(40,547 assignments)};

\node[t1, right=0.3cm of score_pol] (train)
  {\textbf{Train LR Classifier}\\Reference pool: 62,513\\
   $\rightarrow$ 52,779 train / 9,734 test\\
   $C=10$, L2, lbfgs\\
   Macro-$F_1 = 0.823$};
