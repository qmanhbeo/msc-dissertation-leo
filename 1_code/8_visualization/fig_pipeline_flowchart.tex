...
\node[t2] (r_src) {\textbf{OpenAlex}\\68 Boolean Queries\\2018--2025\\(2,543,698 preprocessed abstracts)};
...
\node[t2, below=of r_prep] (r_seg) {\textbf{Segment}\\token-aware segmenter\\(3,105,144 segments\\from 2,536,771 abstracts)};
...
\node[shared, below=1.2cm of p_seg] (embed)
   {\textbf{Embedding}\\all-mpnet-base-v2 (768d, L2-normalised)\\
    \textnormal{Research 3,105,144 segments $\mid$ Policy 40,597 $\mid$ Reference 62,173 $\mid$ Total 3,207,914}};

%% ====================  ROW 5: TRAIN + SCORE  ====================

\node[t2, below=0.7cm of embed.south -| r_seg.south] (score_res)
  {\textbf{Score Research}\\LR argmax over 17 SDGs\\(3,105,144 segment assignments)};
...
\node[shared, below=0.5cm of $(score_res.south)!0.5!(train.south)$] (analysis)
  {\textbf{Downstream Analysis}\\Coverage Gap $\longleftrightarrow$ Semantic Gap (INLP) $\longrightarrow$ Coverage--Semantic Interaction\\Figures 3--5};
...
\node[anchor=north, inner sep=0pt] at (leg) {
  \footnotesize
  \colorbox{research}{\strut\hspace{7mm}}\hspace{0.3em}Research\hspace{1.1em}%
  \colorbox{policy}{\strut\hspace{7mm}}\hspace{0.3em}Policy\hspace{1.1em}%
  \colorbox{reference}{\strut\hspace{7mm}}\hspace{0.3em}Reference\hspace{1.1em}%
  \colorbox{sharedbg}{\strut\hspace{7mm}}\hspace{0.3em}Shared
};
