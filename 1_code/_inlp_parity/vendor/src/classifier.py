# Vendored verbatim from https://github.com/shauli-ravfogel/nullspace_projection
# commit e1edcc19d808108ab71cbb3afb0389db0206a7eb (2022-06-06)
# MIT License, Copyright (c) 2022 Shauli Ravfogel.
# Used ONLY by 1_code/_inlp_parity/run_parity.py for the INLP algorithmic-parity
# check. Not modified except for this attribution header.
