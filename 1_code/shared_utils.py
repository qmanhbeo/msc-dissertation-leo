...
MANUSCRIPT_EXTRA_FILES = [
    ...
    "appendix/a3_source_family_sensitivity/data/policy_source_family_summary.csv",
    "appendix/a3_source_family_sensitivity/data/policy_source_family_coverage.csv",
    "appendix/a3_source_family_sensitivity/data/policy_source_family_semantic_gaps.csv",
    "appendix/a4_sdg4_audit/data/sdg4_lexical_audit.csv",
    "appendix/a4_sdg4_audit/data/sdg4_lexical_audit_summary.json",
...
MANUSCRIPT_APPENDIX_TABLE_FILES = [
    ...
    "appendix/a2_bootstrap_validation_ci/tables/tab_validation_ci.tex",
    "appendix/a3_source_family_sensitivity/tables/tab_a3_policy_source_family_covshare.tex",
    "appendix/a3_source_family_sensitivity/tables/tab_a3_policy_source_family_gap.tex",
    "appendix/a4_sdg4_audit/tables/tab_a4_sdg4_lexical_audit.tex",
    ...
    "appendix/e_register_adjustment/tables/num_regression_register_alignment.tex",
    "appendix/e_register_adjustment/tables/num_sdg_register_robustness.tex",
    "appendix/e_register_adjustment/tables/tab_register_adjusted_semgap.tex",
    "appendix/e_register_adjustment/tables/tab_register_confidence_checks.tex",
    "appendix/e_register_adjustment/tables/tab_register_projection_examples.tex",
    "appendix/e_register_adjustment/tables/tab_register_sdg_alignment.tex",
    "appendix/e_register_adjustment/tables/tab_regression_register_alignment.tex",
    "appendix/e_register_adjustment/tables/tab_sdg_register_robustness.tex",
...
MANUSCRIPT_APPENDIX_FIGURE_FILES = [
    "appendix/a5_centroid_similarity/figures/fig_a5_centroid_similarity_heatmap.pdf",
    "appendix/a5_centroid_similarity/figures/fig_a5_centroid_similarity_heatmap.png",
    ...
    "appendix/e_register_adjustment/figures/fig_register_confidence_curve.png",
    "appendix/e_register_adjustment/figures/fig_register_projection_distribution.pdf",
    "appendix/e_register_adjustment/figures/fig_register_projection_distribution.png",
    "appendix/e_register_adjustment/figures/fig_register_sdg_alignment.pdf",
    "appendix/e_register_adjustment/figures/fig_register_sdg_alignment.png",
    "appendix/e_register_adjustment/figures/fig_regression_vs_classifier_alignment.pdf",
    "appendix/e_register_adjustment/figures/fig_regression_vs_classifier_alignment.png",
    "appendix/e_register_adjustment/figures/fig_sdg_register_robustness_comparison.pdf",
    "appendix/e_register_adjustment/figures/fig_sdg_register_robustness_comparison.png",
]
