...
Input:  data/0_raw/policy_manual/pdf/*.pdf
Output: data/0_raw/policy_manual/texts/<pdf_stem>.txt
...
Run from project root:
    python code/0_fetch/convert_policy_manual.py
"""
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--input-dir",
        type=Path,
        default=Path("data/0_raw/policy_manual/pdf"),
        help="Directory containing manually downloaded PDFs.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("data/0_raw/policy_manual/texts"),
        help="Directory to write extracted .txt files.",
    )
    parser.add_argument(
        "--report-path",
        type=Path,
        default=Path("data/0_raw/policy_manual/artifact/convert_policy_manual_summary.json"),
