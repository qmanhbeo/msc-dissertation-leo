...
Input sources:
  ...
  data/1_preprocessed/policy_all/sdgi_corpus/sdgi_chunks.jsonl
  data/1_preprocessed/policy_all/ungdc_sdg/ungdc_sdg_chunks.jsonl

Output:
  data/1_preprocessed/policy_all/policy_chunks_all.jsonl
  data/1_preprocessed/policy_all/policy_chunks_all.csv
...
SOURCES = [
    Path("data/1_preprocessed/policy_all/policy_scrape/policy_scrape_chunks.jsonl"),
    Path("data/1_preprocessed/policy_all/policy_manual/policy_manual_chunks.jsonl"),
