...
Input:  data/0_raw/sdgi_corpus/sdgi_corpus.parquet
        (~5,880 text excerpts from Voluntary National Reviews and
        Voluntary Local Reviews submitted to the UN HLPF)

Output: data/1_preprocessed/policy_all/sdgi_corpus/sdgi_chunks.jsonl
...
INPUT_PARQUET = Path("data/0_raw/sdgi_corpus/sdgi_corpus.parquet")
OUTPUT_JSONL = Path("data/1_preprocessed/policy_all/sdgi_corpus/sdgi_chunks.jsonl")
