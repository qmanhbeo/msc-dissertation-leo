...
Inputs:
  data/0_raw/policy_scrape/texts/*.txt
  data/0_raw/policy_manual/texts/*.txt

Outputs:
  data/1_preprocessed/policy_all/policy_scrape/policy_scrape_chunks.jsonl
  data/1_preprocessed/policy_all/policy_scrape/policy_scrape_chunks.csv
  data/1_preprocessed/policy_all/policy_manual/policy_manual_chunks.jsonl
  data/1_preprocessed/policy_all/policy_manual/policy_manual_chunks.csv
...
SOURCE_CONFIGS = [
    {
        ...
        "input_dir": Path("data/0_raw/policy_scrape/texts"),
        "output_jsonl": Path("data/1_preprocessed/policy_all/policy_scrape/policy_scrape_chunks.jsonl"),
        "output_csv": Path("data/1_preprocessed/policy_all/policy_scrape/policy_scrape_chunks.csv"),
    },
    {
        "source_name": "policy_manual",
        "input_dir": Path("data/0_raw/policy_manual/texts"),
        "output_jsonl": Path("data/1_preprocessed/policy_all/policy_manual/policy_manual_chunks.jsonl"),
        "output_csv": Path("data/1_preprocessed/policy_all/policy_manual/policy_manual_chunks.csv"),
    },
]
