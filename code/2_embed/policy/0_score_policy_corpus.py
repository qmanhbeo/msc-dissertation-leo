...
Outputs:
  data/3_scored/policy_scores.npy
  data/3_scored/policy_scores_vs_research.npy
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--policy-vs-research-out", default="data/3_scored/policy_scores_vs_research.npy")
    p.add_argument("--policy-score-ids-out", default="data/3_scored/metadata/policy_scores_ids.json")
    return p.parse_args()
