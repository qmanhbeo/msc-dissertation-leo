...
Run from project root (after score materialization for the target run context):
    python code/3_main_analysis/1_canonical/0_coverage_gap.py
"""
...
def main() -> None:
    ...
    log.info("")
    log.info("Next step: python code/3_main_analysis/1_canonical/1_semantic_gap.py")
    ...
    num_lines = [
        "% Auto-generated by code/3_main_analysis/1_canonical/0_coverage_gap.py — do not edit manually",
