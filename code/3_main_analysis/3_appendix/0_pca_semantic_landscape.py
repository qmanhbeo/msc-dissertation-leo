...
Run from project root:
    python code/3_main_analysis/3_appendix/0_pca_semantic_landscape.py
"""
...
def write_num_tex(path: Path, payload: dict) -> None:
    ...
    lines = [
        "% Auto-generated by code/3_main_analysis/3_appendix/0_pca_semantic_landscape.py — do not edit manually",
