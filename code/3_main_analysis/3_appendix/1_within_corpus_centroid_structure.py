...
Run from project root:
    python code/3_main_analysis/3_appendix/1_within_corpus_centroid_structure.py
"""
...
def write_num_tex(path: Path, summary: dict[str, object]) -> None:
    ...
    def latex_int(v: int) -> str:
        return f"{v:,}".replace(",", "{,}")
    lines = [
        "% Auto-generated by code/3_main_analysis/3_appendix/1_within_corpus_centroid_structure.py — do not edit manually",
