...
Run from project root:
    python code/3_main_analysis/3_appendix/2_softmax_multilabel_sdg.py
"""
...
def write_num_tex(path: Path, summary_rows: list[dict]) -> None:
    ...
    lines = [
        "% Auto-generated by code/3_main_analysis/3_appendix/2_softmax_multilabel_sdg.py — do not edit manually",
