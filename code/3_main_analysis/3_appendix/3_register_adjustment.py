...
DEFAULT_CACHE_ROOT = Path("data/3_scored/register_adjustment_cache")
...
def write_sdg_register_adjustment_note(
    ...
    *,
    ...
    note = [
        ...
        "",
        "How to run:",
        f"- `python code/3_main_analysis/3_appendix/3_register_adjustment.py --method {method}`",
        "",
...
def main() -> None:
    ...
    base_signature = {
        ...
        "script": "code/3_main_analysis/3_appendix/3_register_adjustment.py",
    }
