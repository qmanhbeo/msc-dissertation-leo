...
Run from project root:
    python code/3_main_analysis/3_appendix/4_policy_source_family_sensitivity.py
"""
...
POLICY_PREPROCESSED_ROOT = Path("data/1_preprocessed/policy_all")
...
def write_table(path: Path, summary_rows: list[dict]) -> None:
    lines = [
        "% Auto-generated by code/3_main_analysis/3_appendix/4_policy_source_family_sensitivity.py — do not edit manually",
        r"\begin{tabular}{lrrp{3.0cm}cp{3.7cm}}",
        r"\toprule",
        r"Policy source family & Docs & Chunks & \shortstack[l]{Top 3 SDGs\\(doc-weighted)} & \shortstack[l]{Mean semantic\\gap vs research} & Interpretation note \\",
        r"\midrule",
    ]
