...
Run from project root:
    python code/3_main_analysis/3_appendix/7_semantic_gap_text_interpretability.py
"""
...
def main() -> None:
    ...
    summary = {
        "generated_from": "code/3_main_analysis/3_appendix/7_semantic_gap_text_interpretability.py",
