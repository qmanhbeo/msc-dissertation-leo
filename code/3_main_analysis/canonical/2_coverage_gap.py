...
Run from project root (after score materialization for the target run context):
    python code/3_main_analysis/canonical/2_coverage_gap.py
"""
...
def main() -> None:
    ...
    log.info("")
    log.info("Next step: python code/3_main_analysis/canonical/3_semantic_gap.py")
    ...
    num_lines = [
        "% Auto-generated by code/3_main_analysis/canonical/2_coverage_gap.py — do not edit manually",
