...
Run from project root (after the canonical coverage and semantic outputs exist):
    python code/3_main_analysis/canonical/2_coverage_semantic_interaction.py
"""
...
def main() -> None:
    ...
    num_lines = [
        "% Auto-generated by code/3_main_analysis/canonical/2_coverage_semantic_interaction.py — do not edit manually",
