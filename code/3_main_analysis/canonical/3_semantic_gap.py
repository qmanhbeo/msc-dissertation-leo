...
Run from project root:
    python code/3_main_analysis/canonical/3_semantic_gap.py
"""
...
def main() -> None:
    ...
    log.info("")
    log.info("Next step: python code/3_main_analysis/canonical/4_coverage_semantic_interaction.py")
    ...
    num_lines = [
        "% Auto-generated by code/3_main_analysis/canonical/3_semantic_gap.py — do not edit manually",
