...
def write_regression_latex_outputs(
    ...
    *,
    ...
    num_lines = [
        "% Auto-generated by code/3_main_analysis/genre_adjustment.py — do not edit manually",
...
def write_sdg_genre_adjustment_note(
    ...
    *,
    ...
    note = [
        ...
        "",
        "How to run:",
        f"- `python code/3_main_analysis/genre_adjustment.py --method {method}`",
        "",
...
def main() -> None:
    ...
    base_signature = {
        ...
        "script": "code/3_main_analysis/genre_adjustment.py",
    }
