...
Input:  data/ungdc/TXT/Session <N> - <YEAR>/<ISO>_<session>_<year>.txt
        Sessions 70–80 (2015–2024) — post-SDG-adoption speeches only

Output: data/ungdc_sdg/ungdc_sdg_chunks.jsonl
...
UNGDC_TXT_DIR = Path("data/ungdc/TXT")
OUTPUT_DIR = Path("data/ungdc_sdg")
