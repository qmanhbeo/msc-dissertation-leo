...
Input:  data/osdg/osdg_dataset.csv  (TSV, 43,025 rows)
Output: data/osdg/osdg_clean.jsonl  — filtered, cleaned records
        data/osdg/osdg_clean.csv    — flat CSV for inspection
...
# Config
# ---------------------------------------------------------------------------
INPUT_FILE = Path("data/osdg/osdg_dataset.csv")
OUTPUT_JSONL = Path("data/osdg/osdg_clean.jsonl")
OUTPUT_CSV = Path("data/osdg/osdg_clean.csv")
