...
|---|---|---|---|---|
| 27 | UN2015 | UN resolution | SKIP | Webpage only |
| 28 | Paris2015 | International treaty | SKIP | Webpage only |
| 29 | IPCC2022 | IPCC report | SKIP | Webpage only |
| 30 | OECD2019 | OECD principles | SKIP | Webpage only |
| 31 | EUAI2024 | EU legislation | SKIP | Webpage only |
| 32 | UNESCO2021 | UNESCO recommendation | SKIP | Webpage only |
| 33 | UKAI2021 | UK government strategy | SKIP | Webpage only |
| 34 | UNAI2024 | UN report | SKIP | Webpage only |
| 35 | AUAI2024 | AU strategy | SKIP | Webpage only |
| 36 | Sachs2024 | SDG Index report | SKIP | Webpage only |
| 37 | Sachs2025 | SDG Index report | SKIP | Webpage only |
| 38 | SDGi2024 | HuggingFace dataset | SKIP | Dataset |
| 39 | UNGDC2024 | Harvard Dataverse | SKIP | Dataset |
| 40 | Aurora2020SDGSurvey | Zenodo dataset | SKIP | Dataset |
| 41 | SDGBenchmark | GitHub repo | SKIP | Software repo |
