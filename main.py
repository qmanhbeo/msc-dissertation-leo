...
def main() -> None:
    ...
    if args.stage:
        ...
        model = args.embed_model
        # Ensure model-selection CV outputs exist (Appendix D.1 inputs) before
        # the appendix battery runs. No-op for non-MPNet embed models.
        run_model_selection_cv(model, overwrite=args.overwrite)
